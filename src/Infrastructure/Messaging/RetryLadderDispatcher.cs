...
/// <summary>
/// Shared retry/DLQ mechanics for every consumer hosted service in this project (there are two:
/// <see cref="CatalogProjectionConsumerHostedService"/> and <see cref="ReviewEventsConsumerHostedService"/>,
/// both needing the identical manifest-driven TTL-ladder-then-DLQ behavior) - extracted once here
/// instead of duplicating it per consumer.
/// </summary>
public static class RetryLadderDispatcher
{
    private const string RetryCountHeader = "x-product-retry-count";
    ...
    /// </summary>
    private const string OriginalRoutingKeyHeader = "x-product-original-routing-key";
