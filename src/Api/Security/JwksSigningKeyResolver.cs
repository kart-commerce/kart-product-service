...
/// is synchronous; the in-memory cache keeps the blocking fetch to once per CacheDuration.
/// Mirrors kart-admin-service's JwksSigningKeyResolver — every other service in the platform
/// validates Identity's tokens this way; this service previously validated against a symmetric
/// key Identity never actually signs with (see AuthenticationExtensions.cs).
/// </summary>
